...
110 DIM InstructionsArray$(3)  ' Renamed the array to avoid confusion
120 RANDOMIZE
130 PRINT "DO YOU WANT INSTRUCTIONS";  ' Prompt for user input
140 INPUT A$  ' Read user input into a string variable
150 PRINT
160 IF A$ = "NO" THEN 330  ' Handle input
...
230 PRINT "RELATIVE SPEED OF THF TARGET WHFRE 1 IS THE SLOWEST AND 100"
