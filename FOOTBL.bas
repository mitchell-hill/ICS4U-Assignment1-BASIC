...
3060 LET Q=-Q
3070 LET M1=M-1
3080 DIM G1(D*(A, M1) + FNT(Q)) * (D(2, M1) - D*(A, M1)) / 3.5
3090 LET G = G+INT(RND(0)+.02)*A*100*RND(0)
3100 LET G = INT(G)
3110 RETURN
3120 LET D1 = D1+1
3130 IF D1=5 THEN 3240
3140 IF D1 <> 1 THEN 3160
3150 PRINT "1st";
3160 IF D1 <>2 THEN 3180
3170 PRINT "2ND";
3180 IF D1 <>3 THEN 3200
3190 PRINT "3RD";
3200 IF D1 < 4 THEN 3220
3210 PRINT "4TH";
3220 PRINT " AND";B1-B; "   ";
3230 GOTO 810
3240 LET S=3-S
